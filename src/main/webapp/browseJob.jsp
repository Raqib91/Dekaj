<%@page import="com.raqib91.Dao.DeadlineCheckerDao"%>
...
<body>
	...
	<%	
		...
		AbstractApplicationContext appContext3 = new AnnotationConfigApplicationContext(DeadlineCheckerDao.class);
		DeadlineCheckerDao dcd = appContext3.getBean(DeadlineCheckerDao.class);
		dcd.checkDeadline();
